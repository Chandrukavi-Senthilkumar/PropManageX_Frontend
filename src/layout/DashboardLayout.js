...
const DashboardLayout = () => {
  ...
  const { isAuthenticated, userName, userRole, profileDetails, loading: isLoadingProfile } = useSelector((state) => state.auth);
  ...
  const allMenuItems = [
    ...
    { name: 'Revenue Reports', path: '/revenues', icon: CheckBadgeIcon, roles: ['Admin', 'FinanceAnalyst'] },
